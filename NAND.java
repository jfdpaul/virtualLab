...
import java.awt.*;
import javax.swing.*;
class NAND extends Gate                             //class defining AND Gate.
{
    String name;
    Color cl;
    int px,py,r,nr;
    ...
    WorkSpace ws;
    public NAND(int count,WorkSpace p)                                          //Constructor for AND
    {
        setText("NAND");
        ws=p;
        name="NAND"+count;
        ...
        outLink.id=this;
        ws.add(outLink);
        ImageIcon ii=new ImageIcon(getScaledImage(new ImageIcon("images/nand.jpg").getImage(),r,r),"NAND GATE");
        setIcon(ii);
        setBounds(px,py,r,r);
        setOpaque(true);
    ...
    public NAND(int count,WorkSpace p,int n1,int n2,int n3)                                          //Constructor for AND
    {
        setText("NAND");
        ws=p;
        name="NAND"+count;
